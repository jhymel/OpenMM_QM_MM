...
OPENMM_EXPORT int openmm_integrator_getintegrationforcegroups_(const OpenMM_Integrator*& target) {
    return OpenMM_Integrator_getIntegrationForceGroups(target);
}
OPENMM_EXPORT int OPENMM_INTEGRATOR_GETINTEGRATIONFORCEGROUPS(const OpenMM_Integrator*& target) {
    return OpenMM_Integrator_getIntegrationForceGroups(target);
}
OPENMM_EXPORT void openmm_integrator_setintegrationforcegroups_(OpenMM_Integrator*& target, int const& groups) {
    OpenMM_Integrator_setIntegrationForceGroups(target, groups);
}
OPENMM_EXPORT void OPENMM_INTEGRATOR_SETINTEGRATIONFORCEGROUPS(OpenMM_Integrator*& target, int const& groups) {
    OpenMM_Integrator_setIntegrationForceGroups(target, groups);
}
...
OPENMM_EXPORT void openmm_force_getname_(const OpenMM_Force*& target, char* result, int result_length) {
    const char* result_chars = OpenMM_Force_getName(target);
    copyAndPadString(result, result_chars, result_length);
}
OPENMM_EXPORT void OPENMM_FORCE_GETNAME(const OpenMM_Force*& target, char* result, int result_length) {
    const char* result_chars = OpenMM_Force_getName(target);
    copyAndPadString(result, result_chars, result_length);
}
OPENMM_EXPORT void openmm_force_setname_(OpenMM_Force*& target, const char* name, int name_length) {
    OpenMM_Force_setName(target, makeString(name, name_length).c_str());
}
OPENMM_EXPORT void OPENMM_FORCE_SETNAME(OpenMM_Force*& target, const char* name, int name_length) {
    OpenMM_Force_setName(target, makeString(name, name_length).c_str());
}
...
OPENMM_EXPORT void openmm_tabulatedfunction_getperiodic_(const OpenMM_TabulatedFunction*& target, OpenMM_Boolean& result) {
    result = OpenMM_TabulatedFunction_getPeriodic(target);
}
OPENMM_EXPORT void OPENMM_TABULATEDFUNCTION_GETPERIODIC(const OpenMM_TabulatedFunction*& target, OpenMM_Boolean& result) {
    result = OpenMM_TabulatedFunction_getPeriodic(target);
}
...
OPENMM_EXPORT void openmm_montecarloflexiblebarostat_create_(OpenMM_MonteCarloFlexibleBarostat*& result, double const& defaultPressure, double const& defaultTemperature, int const& frequency, OpenMM_Boolean& scaleMoleculesAsRigid) {
    result = OpenMM_MonteCarloFlexibleBarostat_create(defaultPressure, defaultTemperature, frequency, scaleMoleculesAsRigid);
}
OPENMM_EXPORT void OPENMM_MONTECARLOFLEXIBLEBAROSTAT_CREATE(OpenMM_MonteCarloFlexibleBarostat*& result, double const& defaultPressure, double const& defaultTemperature, int const& frequency, OpenMM_Boolean& scaleMoleculesAsRigid) {
    result = OpenMM_MonteCarloFlexibleBarostat_create(defaultPressure, defaultTemperature, frequency, scaleMoleculesAsRigid);
}
OPENMM_EXPORT void openmm_montecarloflexiblebarostat_destroy_(OpenMM_MonteCarloFlexibleBarostat*& destroy) {
    OpenMM_MonteCarloFlexibleBarostat_destroy(destroy);
    destroy = 0;
}
OPENMM_EXPORT void OPENMM_MONTECARLOFLEXIBLEBAROSTAT_DESTROY(OpenMM_MonteCarloFlexibleBarostat*& destroy) {
    OpenMM_MonteCarloFlexibleBarostat_destroy(destroy);
    destroy = 0;
}
OPENMM_EXPORT void openmm_montecarloflexiblebarostat_pressure_(char* result, int result_length) {
    const char* result_chars = OpenMM_MonteCarloFlexibleBarostat_Pressure();
    copyAndPadString(result, result_chars, result_length);
}
OPENMM_EXPORT void OPENMM_MONTECARLOFLEXIBLEBAROSTAT_PRESSURE(char* result, int result_length) {
    const char* result_chars = OpenMM_MonteCarloFlexibleBarostat_Pressure();
    copyAndPadString(result, result_chars, result_length);
}
OPENMM_EXPORT void openmm_montecarloflexiblebarostat_temperature_(char* result, int result_length) {
    const char* result_chars = OpenMM_MonteCarloFlexibleBarostat_Temperature();
    copyAndPadString(result, result_chars, result_length);
}
OPENMM_EXPORT void OPENMM_MONTECARLOFLEXIBLEBAROSTAT_TEMPERATURE(char* result, int result_length) {
    const char* result_chars = OpenMM_MonteCarloFlexibleBarostat_Temperature();
    copyAndPadString(result, result_chars, result_length);
}
OPENMM_EXPORT double openmm_montecarloflexiblebarostat_getdefaultpressure_(const OpenMM_MonteCarloFlexibleBarostat*& target) {
    return OpenMM_MonteCarloFlexibleBarostat_getDefaultPressure(target);
}
OPENMM_EXPORT double OPENMM_MONTECARLOFLEXIBLEBAROSTAT_GETDEFAULTPRESSURE(const OpenMM_MonteCarloFlexibleBarostat*& target) {
    return OpenMM_MonteCarloFlexibleBarostat_getDefaultPressure(target);
}
OPENMM_EXPORT void openmm_montecarloflexiblebarostat_setdefaultpressure_(OpenMM_MonteCarloFlexibleBarostat*& target, double const& pressure) {
    OpenMM_MonteCarloFlexibleBarostat_setDefaultPressure(target, pressure);
}
OPENMM_EXPORT void OPENMM_MONTECARLOFLEXIBLEBAROSTAT_SETDEFAULTPRESSURE(OpenMM_MonteCarloFlexibleBarostat*& target, double const& pressure) {
    OpenMM_MonteCarloFlexibleBarostat_setDefaultPressure(target, pressure);
}
OPENMM_EXPORT int openmm_montecarloflexiblebarostat_getfrequency_(const OpenMM_MonteCarloFlexibleBarostat*& target) {
    return OpenMM_MonteCarloFlexibleBarostat_getFrequency(target);
}
OPENMM_EXPORT int OPENMM_MONTECARLOFLEXIBLEBAROSTAT_GETFREQUENCY(const OpenMM_MonteCarloFlexibleBarostat*& target) {
    return OpenMM_MonteCarloFlexibleBarostat_getFrequency(target);
}
OPENMM_EXPORT void openmm_montecarloflexiblebarostat_setfrequency_(OpenMM_MonteCarloFlexibleBarostat*& target, int const& freq) {
    OpenMM_MonteCarloFlexibleBarostat_setFrequency(target, freq);
}
OPENMM_EXPORT void OPENMM_MONTECARLOFLEXIBLEBAROSTAT_SETFREQUENCY(OpenMM_MonteCarloFlexibleBarostat*& target, int const& freq) {
    OpenMM_MonteCarloFlexibleBarostat_setFrequency(target, freq);
}
OPENMM_EXPORT double openmm_montecarloflexiblebarostat_getdefaulttemperature_(const OpenMM_MonteCarloFlexibleBarostat*& target) {
    return OpenMM_MonteCarloFlexibleBarostat_getDefaultTemperature(target);
}
OPENMM_EXPORT double OPENMM_MONTECARLOFLEXIBLEBAROSTAT_GETDEFAULTTEMPERATURE(const OpenMM_MonteCarloFlexibleBarostat*& target) {
    return OpenMM_MonteCarloFlexibleBarostat_getDefaultTemperature(target);
}
OPENMM_EXPORT void openmm_montecarloflexiblebarostat_setdefaulttemperature_(OpenMM_MonteCarloFlexibleBarostat*& target, double const& temp) {
    OpenMM_MonteCarloFlexibleBarostat_setDefaultTemperature(target, temp);
}
OPENMM_EXPORT void OPENMM_MONTECARLOFLEXIBLEBAROSTAT_SETDEFAULTTEMPERATURE(OpenMM_MonteCarloFlexibleBarostat*& target, double const& temp) {
    OpenMM_MonteCarloFlexibleBarostat_setDefaultTemperature(target, temp);
}
OPENMM_EXPORT int openmm_montecarloflexiblebarostat_getrandomnumberseed_(const OpenMM_MonteCarloFlexibleBarostat*& target) {
    return OpenMM_MonteCarloFlexibleBarostat_getRandomNumberSeed(target);
}
OPENMM_EXPORT int OPENMM_MONTECARLOFLEXIBLEBAROSTAT_GETRANDOMNUMBERSEED(const OpenMM_MonteCarloFlexibleBarostat*& target) {
    return OpenMM_MonteCarloFlexibleBarostat_getRandomNumberSeed(target);
}
OPENMM_EXPORT void openmm_montecarloflexiblebarostat_setrandomnumberseed_(OpenMM_MonteCarloFlexibleBarostat*& target, int const& seed) {
    OpenMM_MonteCarloFlexibleBarostat_setRandomNumberSeed(target, seed);
}
OPENMM_EXPORT void OPENMM_MONTECARLOFLEXIBLEBAROSTAT_SETRANDOMNUMBERSEED(OpenMM_MonteCarloFlexibleBarostat*& target, int const& seed) {
    OpenMM_MonteCarloFlexibleBarostat_setRandomNumberSeed(target, seed);
}
OPENMM_EXPORT void openmm_montecarloflexiblebarostat_usesperiodicboundarycondition_(const OpenMM_MonteCarloFlexibleBarostat*& target, OpenMM_Boolean& result) {
    result = OpenMM_MonteCarloFlexibleBarostat_usesPeriodicBoundaryConditions(target);
}
OPENMM_EXPORT void OPENMM_MONTECARLOFLEXIBLEBAROSTAT_USESPERIODICBOUNDARYCONDITION(const OpenMM_MonteCarloFlexibleBarostat*& target, OpenMM_Boolean& result) {
    result = OpenMM_MonteCarloFlexibleBarostat_usesPeriodicBoundaryConditions(target);
}
OPENMM_EXPORT void openmm_montecarloflexiblebarostat_getscalemoleculesasrigid_(const OpenMM_MonteCarloFlexibleBarostat*& target, OpenMM_Boolean& result) {
    result = OpenMM_MonteCarloFlexibleBarostat_getScaleMoleculesAsRigid(target);
}
OPENMM_EXPORT void OPENMM_MONTECARLOFLEXIBLEBAROSTAT_GETSCALEMOLECULESASRIGID(const OpenMM_MonteCarloFlexibleBarostat*& target, OpenMM_Boolean& result) {
    result = OpenMM_MonteCarloFlexibleBarostat_getScaleMoleculesAsRigid(target);
}
OPENMM_EXPORT void openmm_montecarloflexiblebarostat_setscalemoleculesasrigid_(OpenMM_MonteCarloFlexibleBarostat*& target, OpenMM_Boolean& rigid) {
    OpenMM_MonteCarloFlexibleBarostat_setScaleMoleculesAsRigid(target, rigid);
}
OPENMM_EXPORT void OPENMM_MONTECARLOFLEXIBLEBAROSTAT_SETSCALEMOLECULESASRIGID(OpenMM_MonteCarloFlexibleBarostat*& target, OpenMM_Boolean& rigid) {
    OpenMM_MonteCarloFlexibleBarostat_setScaleMoleculesAsRigid(target, rigid);
}
...
OPENMM_EXPORT void openmm_nonbondedforce_getincludedirectspace_(const OpenMM_NonbondedForce*& target, OpenMM_Boolean& result) {
    result = OpenMM_NonbondedForce_getIncludeDirectSpace(target);
}
OPENMM_EXPORT void OPENMM_NONBONDEDFORCE_GETINCLUDEDIRECTSPACE(const OpenMM_NonbondedForce*& target, OpenMM_Boolean& result) {
    result = OpenMM_NonbondedForce_getIncludeDirectSpace(target);
}
OPENMM_EXPORT void openmm_nonbondedforce_setincludedirectspace_(OpenMM_NonbondedForce*& target, OpenMM_Boolean& include) {
    OpenMM_NonbondedForce_setIncludeDirectSpace(target, include);
}
OPENMM_EXPORT void OPENMM_NONBONDEDFORCE_SETINCLUDEDIRECTSPACE(OpenMM_NonbondedForce*& target, OpenMM_Boolean& include) {
    OpenMM_NonbondedForce_setIncludeDirectSpace(target, include);
}
...
OPENMM_EXPORT void openmm_continuous3dfunction_create_(OpenMM_Continuous3DFunction*& result, int const& xsize, int const& ysize, int const& zsize, const OpenMM_DoubleArray*& values, double const& xmin, double const& xmax, double const& ymin, double const& ymax, double const& zmin, double const& zmax, OpenMM_Boolean& periodic) {
    result = OpenMM_Continuous3DFunction_create(xsize, ysize, zsize, values, xmin, xmax, ymin, ymax, zmin, zmax, periodic);
}
OPENMM_EXPORT void OPENMM_CONTINUOUS3DFUNCTION_CREATE(OpenMM_Continuous3DFunction*& result, int const& xsize, int const& ysize, int const& zsize, const OpenMM_DoubleArray*& values, double const& xmin, double const& xmax, double const& ymin, double const& ymax, double const& zmin, double const& zmax, OpenMM_Boolean& periodic) {
    result = OpenMM_Continuous3DFunction_create(xsize, ysize, zsize, values, xmin, xmax, ymin, ymax, zmin, zmax, periodic);
}
...
OPENMM_EXPORT void openmm_platform_setpropertyvalue_(OpenMM_Platform*& target, OpenMM_Context*& context, const char* property, const char* value, int property_length, int value_length) {
...
OPENMM_EXPORT void OPENMM_PLATFORM_SETPROPERTYVALUE(OpenMM_Platform*& target, OpenMM_Context*& context, const char* property, const char* value, int property_length, int value_length) {
    OpenMM_Platform_setPropertyValue(target, context, makeString(property, property_length).c_str(), makeString(value, value_length).c_str());
}
...
OPENMM_EXPORT void openmm_continuous2dfunction_create_(OpenMM_Continuous2DFunction*& result, int const& xsize, int const& ysize, const OpenMM_DoubleArray*& values, double const& xmin, double const& xmax, double const& ymin, double const& ymax, OpenMM_Boolean& periodic) {
    result = OpenMM_Continuous2DFunction_create(xsize, ysize, values, xmin, xmax, ymin, ymax, periodic);
}
OPENMM_EXPORT void OPENMM_CONTINUOUS2DFUNCTION_CREATE(OpenMM_Continuous2DFunction*& result, int const& xsize, int const& ysize, const OpenMM_DoubleArray*& values, double const& xmin, double const& xmax, double const& ymin, double const& ymax, OpenMM_Boolean& periodic) {
    result = OpenMM_Continuous2DFunction_create(xsize, ysize, values, xmin, xmax, ymin, ymax, periodic);
}
...
OPENMM_EXPORT double openmm_context_gettime_(const OpenMM_Context*& target) {
    return OpenMM_Context_getTime(target);
}
OPENMM_EXPORT double OPENMM_CONTEXT_GETTIME(const OpenMM_Context*& target) {
    return OpenMM_Context_getTime(target);
}
...
OPENMM_EXPORT void openmm_context_getstepcount_(const OpenMM_Context*& target, long long& result) {
    result = OpenMM_Context_getStepCount(target);
}
OPENMM_EXPORT void OPENMM_CONTEXT_GETSTEPCOUNT(const OpenMM_Context*& target, long long& result) {
    result = OpenMM_Context_getStepCount(target);
}
OPENMM_EXPORT void openmm_context_setstepcount_(OpenMM_Context*& target, long long const& count) {
    OpenMM_Context_setStepCount(target, count);
}
OPENMM_EXPORT void OPENMM_CONTEXT_SETSTEPCOUNT(OpenMM_Context*& target, long long const& count) {
    OpenMM_Context_setStepCount(target, count);
}
...
OPENMM_EXPORT void openmm_state_getstepcount_(const OpenMM_State*& target, long long& result) {
    result = OpenMM_State_getStepCount(target);
}
OPENMM_EXPORT void OPENMM_STATE_GETSTEPCOUNT(const OpenMM_State*& target, long long& result) {
    result = OpenMM_State_getStepCount(target);
}
...
OPENMM_EXPORT void openmm_state_getvext_grid_(const OpenMM_State*& target, const OpenMM_DoubleArray*& result) {
    result = OpenMM_State_getVext_grid(target);
}
OPENMM_EXPORT void OPENMM_STATE_GETVEXT_GRID(const OpenMM_State*& target, const OpenMM_DoubleArray*& result) {
    result = OpenMM_State_getVext_grid(target);
}
...
OPENMM_EXPORT void openmm_langevinmiddleintegrator_create_(OpenMM_LangevinMiddleIntegrator*& result, double const& temperature, double const& frictionCoeff, double const& stepSize) {
    result = OpenMM_LangevinMiddleIntegrator_create(temperature, frictionCoeff, stepSize);
}
OPENMM_EXPORT void OPENMM_LANGEVINMIDDLEINTEGRATOR_CREATE(OpenMM_LangevinMiddleIntegrator*& result, double const& temperature, double const& frictionCoeff, double const& stepSize) {
    result = OpenMM_LangevinMiddleIntegrator_create(temperature, frictionCoeff, stepSize);
}
OPENMM_EXPORT void openmm_langevinmiddleintegrator_destroy_(OpenMM_LangevinMiddleIntegrator*& destroy) {
    OpenMM_LangevinMiddleIntegrator_destroy(destroy);
    destroy = 0;
}
OPENMM_EXPORT void OPENMM_LANGEVINMIDDLEINTEGRATOR_DESTROY(OpenMM_LangevinMiddleIntegrator*& destroy) {
    OpenMM_LangevinMiddleIntegrator_destroy(destroy);
    destroy = 0;
}
OPENMM_EXPORT double openmm_langevinmiddleintegrator_gettemperature_(const OpenMM_LangevinMiddleIntegrator*& target) {
    return OpenMM_LangevinMiddleIntegrator_getTemperature(target);
}
OPENMM_EXPORT double OPENMM_LANGEVINMIDDLEINTEGRATOR_GETTEMPERATURE(const OpenMM_LangevinMiddleIntegrator*& target) {
    return OpenMM_LangevinMiddleIntegrator_getTemperature(target);
}
OPENMM_EXPORT void openmm_langevinmiddleintegrator_settemperature_(OpenMM_LangevinMiddleIntegrator*& target, double const& temp) {
    OpenMM_LangevinMiddleIntegrator_setTemperature(target, temp);
}
OPENMM_EXPORT void OPENMM_LANGEVINMIDDLEINTEGRATOR_SETTEMPERATURE(OpenMM_LangevinMiddleIntegrator*& target, double const& temp) {
    OpenMM_LangevinMiddleIntegrator_setTemperature(target, temp);
}
OPENMM_EXPORT double openmm_langevinmiddleintegrator_getfriction_(const OpenMM_LangevinMiddleIntegrator*& target) {
    return OpenMM_LangevinMiddleIntegrator_getFriction(target);
}
OPENMM_EXPORT double OPENMM_LANGEVINMIDDLEINTEGRATOR_GETFRICTION(const OpenMM_LangevinMiddleIntegrator*& target) {
    return OpenMM_LangevinMiddleIntegrator_getFriction(target);
}
OPENMM_EXPORT void openmm_langevinmiddleintegrator_setfriction_(OpenMM_LangevinMiddleIntegrator*& target, double const& coeff) {
    OpenMM_LangevinMiddleIntegrator_setFriction(target, coeff);
}
OPENMM_EXPORT void OPENMM_LANGEVINMIDDLEINTEGRATOR_SETFRICTION(OpenMM_LangevinMiddleIntegrator*& target, double const& coeff) {
    OpenMM_LangevinMiddleIntegrator_setFriction(target, coeff);
}
OPENMM_EXPORT int openmm_langevinmiddleintegrator_getrandomnumberseed_(const OpenMM_LangevinMiddleIntegrator*& target) {
    return OpenMM_LangevinMiddleIntegrator_getRandomNumberSeed(target);
}
OPENMM_EXPORT int OPENMM_LANGEVINMIDDLEINTEGRATOR_GETRANDOMNUMBERSEED(const OpenMM_LangevinMiddleIntegrator*& target) {
    return OpenMM_LangevinMiddleIntegrator_getRandomNumberSeed(target);
}
OPENMM_EXPORT void openmm_langevinmiddleintegrator_setrandomnumberseed_(OpenMM_LangevinMiddleIntegrator*& target, int const& seed) {
    OpenMM_LangevinMiddleIntegrator_setRandomNumberSeed(target, seed);
}
OPENMM_EXPORT void OPENMM_LANGEVINMIDDLEINTEGRATOR_SETRANDOMNUMBERSEED(OpenMM_LangevinMiddleIntegrator*& target, int const& seed) {
    OpenMM_LangevinMiddleIntegrator_setRandomNumberSeed(target, seed);
}
OPENMM_EXPORT void openmm_langevinmiddleintegrator_step_(OpenMM_LangevinMiddleIntegrator*& target, int const& steps) {
    OpenMM_LangevinMiddleIntegrator_step(target, steps);
}
OPENMM_EXPORT void OPENMM_LANGEVINMIDDLEINTEGRATOR_STEP(OpenMM_LangevinMiddleIntegrator*& target, int const& steps) {
    OpenMM_LangevinMiddleIntegrator_step(target, steps);
}
...
OPENMM_EXPORT void openmm_continuous1dfunction_create_(OpenMM_Continuous1DFunction*& result, const OpenMM_DoubleArray*& values, double const& min, double const& max, OpenMM_Boolean& periodic) {
    result = OpenMM_Continuous1DFunction_create(values, min, max, periodic);
}
OPENMM_EXPORT void OPENMM_CONTINUOUS1DFUNCTION_CREATE(OpenMM_Continuous1DFunction*& result, const OpenMM_DoubleArray*& values, double const& min, double const& max, OpenMM_Boolean& periodic) {
    result = OpenMM_Continuous1DFunction_create(values, min, max, periodic);
}
