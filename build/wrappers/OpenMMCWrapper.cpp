...
OPENMM_EXPORT int OpenMM_Integrator_getIntegrationForceGroups(const OpenMM_Integrator* target) {
    int result = reinterpret_cast<const OpenMM::Integrator*>(target)->getIntegrationForceGroups();
    return result;
}
OPENMM_EXPORT void OpenMM_Integrator_setIntegrationForceGroups(OpenMM_Integrator* target, int groups) {
    reinterpret_cast<OpenMM::Integrator*>(target)->setIntegrationForceGroups(groups);
}
...
OPENMM_EXPORT const char* OpenMM_Force_getName(const OpenMM_Force* target) {
    const std::string* result = &reinterpret_cast<const OpenMM::Force*>(target)->getName();
    return result->c_str();
}
OPENMM_EXPORT void OpenMM_Force_setName(OpenMM_Force* target, const char* name) {
    reinterpret_cast<OpenMM::Force*>(target)->setName(std::string(name));
}
...
OPENMM_EXPORT OpenMM_Boolean OpenMM_TabulatedFunction_getPeriodic(const OpenMM_TabulatedFunction* target) {
    bool result = reinterpret_cast<const OpenMM::TabulatedFunction*>(target)->getPeriodic();
    return (result ? OpenMM_True : OpenMM_False);
}
...
OPENMM_EXPORT OpenMM_MonteCarloFlexibleBarostat* OpenMM_MonteCarloFlexibleBarostat_create(double defaultPressure, double defaultTemperature, int frequency, OpenMM_Boolean scaleMoleculesAsRigid) {
    return reinterpret_cast<OpenMM_MonteCarloFlexibleBarostat*>(new OpenMM::MonteCarloFlexibleBarostat(defaultPressure, defaultTemperature, frequency, scaleMoleculesAsRigid));
}
OPENMM_EXPORT void OpenMM_MonteCarloFlexibleBarostat_destroy(OpenMM_MonteCarloFlexibleBarostat* target) {
    delete reinterpret_cast<OpenMM::MonteCarloFlexibleBarostat*>(target);
}
OPENMM_EXPORT const char* OpenMM_MonteCarloFlexibleBarostat_Pressure() {
    const std::string* result = &OpenMM::MonteCarloFlexibleBarostat::Pressure();
    return result->c_str();
}
OPENMM_EXPORT const char* OpenMM_MonteCarloFlexibleBarostat_Temperature() {
    const std::string* result = &OpenMM::MonteCarloFlexibleBarostat::Temperature();
    return result->c_str();
}
OPENMM_EXPORT double OpenMM_MonteCarloFlexibleBarostat_getDefaultPressure(const OpenMM_MonteCarloFlexibleBarostat* target) {
    double result = reinterpret_cast<const OpenMM::MonteCarloFlexibleBarostat*>(target)->getDefaultPressure();
    return result;
}
OPENMM_EXPORT void OpenMM_MonteCarloFlexibleBarostat_setDefaultPressure(OpenMM_MonteCarloFlexibleBarostat* target, double pressure) {
    reinterpret_cast<OpenMM::MonteCarloFlexibleBarostat*>(target)->setDefaultPressure(pressure);
}
OPENMM_EXPORT int OpenMM_MonteCarloFlexibleBarostat_getFrequency(const OpenMM_MonteCarloFlexibleBarostat* target) {
    int result = reinterpret_cast<const OpenMM::MonteCarloFlexibleBarostat*>(target)->getFrequency();
    return result;
}
OPENMM_EXPORT void OpenMM_MonteCarloFlexibleBarostat_setFrequency(OpenMM_MonteCarloFlexibleBarostat* target, int freq) {
    reinterpret_cast<OpenMM::MonteCarloFlexibleBarostat*>(target)->setFrequency(freq);
}
OPENMM_EXPORT double OpenMM_MonteCarloFlexibleBarostat_getDefaultTemperature(const OpenMM_MonteCarloFlexibleBarostat* target) {
    double result = reinterpret_cast<const OpenMM::MonteCarloFlexibleBarostat*>(target)->getDefaultTemperature();
    return result;
}
OPENMM_EXPORT void OpenMM_MonteCarloFlexibleBarostat_setDefaultTemperature(OpenMM_MonteCarloFlexibleBarostat* target, double temp) {
    reinterpret_cast<OpenMM::MonteCarloFlexibleBarostat*>(target)->setDefaultTemperature(temp);
}
OPENMM_EXPORT int OpenMM_MonteCarloFlexibleBarostat_getRandomNumberSeed(const OpenMM_MonteCarloFlexibleBarostat* target) {
    int result = reinterpret_cast<const OpenMM::MonteCarloFlexibleBarostat*>(target)->getRandomNumberSeed();
    return result;
}
OPENMM_EXPORT void OpenMM_MonteCarloFlexibleBarostat_setRandomNumberSeed(OpenMM_MonteCarloFlexibleBarostat* target, int seed) {
    reinterpret_cast<OpenMM::MonteCarloFlexibleBarostat*>(target)->setRandomNumberSeed(seed);
}
OPENMM_EXPORT OpenMM_Boolean OpenMM_MonteCarloFlexibleBarostat_usesPeriodicBoundaryConditions(const OpenMM_MonteCarloFlexibleBarostat* target) {
    bool result = reinterpret_cast<const OpenMM::MonteCarloFlexibleBarostat*>(target)->usesPeriodicBoundaryConditions();
    return (result ? OpenMM_True : OpenMM_False);
}
OPENMM_EXPORT OpenMM_Boolean OpenMM_MonteCarloFlexibleBarostat_getScaleMoleculesAsRigid(const OpenMM_MonteCarloFlexibleBarostat* target) {
    bool result = reinterpret_cast<const OpenMM::MonteCarloFlexibleBarostat*>(target)->getScaleMoleculesAsRigid();
    return (result ? OpenMM_True : OpenMM_False);
}
OPENMM_EXPORT void OpenMM_MonteCarloFlexibleBarostat_setScaleMoleculesAsRigid(OpenMM_MonteCarloFlexibleBarostat* target, OpenMM_Boolean rigid) {
    reinterpret_cast<OpenMM::MonteCarloFlexibleBarostat*>(target)->setScaleMoleculesAsRigid(rigid);
}
...
OPENMM_EXPORT OpenMM_Boolean OpenMM_NonbondedForce_getIncludeDirectSpace(const OpenMM_NonbondedForce* target) {
    bool result = reinterpret_cast<const OpenMM::NonbondedForce*>(target)->getIncludeDirectSpace();
    return (result ? OpenMM_True : OpenMM_False);
}
OPENMM_EXPORT void OpenMM_NonbondedForce_setIncludeDirectSpace(OpenMM_NonbondedForce* target, OpenMM_Boolean include) {
    reinterpret_cast<OpenMM::NonbondedForce*>(target)->setIncludeDirectSpace(include);
}
...
OPENMM_EXPORT OpenMM_Continuous3DFunction* OpenMM_Continuous3DFunction_create(int xsize, int ysize, int zsize, const OpenMM_DoubleArray* values, double xmin, double xmax, double ymin, double ymax, double zmin, double zmax, OpenMM_Boolean periodic) {
    return reinterpret_cast<OpenMM_Continuous3DFunction*>(new OpenMM::Continuous3DFunction(xsize, ysize, zsize, *reinterpret_cast<const std::vector< double >*>(values), xmin, xmax, ymin, ymax, zmin, zmax, periodic));
}
...
OPENMM_EXPORT void OpenMM_Platform_setPropertyValue(OpenMM_Platform* target, OpenMM_Context* context, const char* property, const char* value) {
    reinterpret_cast<OpenMM::Platform*>(target)->setPropertyValue(*reinterpret_cast<OpenMM::Context*>(context), std::string(property), std::string(value));
}
...
OPENMM_EXPORT OpenMM_Continuous2DFunction* OpenMM_Continuous2DFunction_create(int xsize, int ysize, const OpenMM_DoubleArray* values, double xmin, double xmax, double ymin, double ymax, OpenMM_Boolean periodic) {
    return reinterpret_cast<OpenMM_Continuous2DFunction*>(new OpenMM::Continuous2DFunction(xsize, ysize, *reinterpret_cast<const std::vector< double >*>(values), xmin, xmax, ymin, ymax, periodic));
}
...
OPENMM_EXPORT double OpenMM_Context_getTime(const OpenMM_Context* target) {
    double result = reinterpret_cast<const OpenMM::Context*>(target)->getTime();
    return result;
}
...
OPENMM_EXPORT long long OpenMM_Context_getStepCount(const OpenMM_Context* target) {
    long long result = reinterpret_cast<const OpenMM::Context*>(target)->getStepCount();
    return result;
}
OPENMM_EXPORT void OpenMM_Context_setStepCount(OpenMM_Context* target, long long count) {
    reinterpret_cast<OpenMM::Context*>(target)->setStepCount(count);
}
...
OPENMM_EXPORT long long OpenMM_State_getStepCount(const OpenMM_State* target) {
    long long result = reinterpret_cast<const OpenMM::State*>(target)->getStepCount();
    return result;
}
...
OPENMM_EXPORT const OpenMM_DoubleArray* OpenMM_State_getVext_grid(const OpenMM_State* target) {
    const std::vector< double >* result = &reinterpret_cast<const OpenMM::State*>(target)->getVext_grid();
...
OPENMM_EXPORT OpenMM_LangevinMiddleIntegrator* OpenMM_LangevinMiddleIntegrator_create(double temperature, double frictionCoeff, double stepSize) {
    return reinterpret_cast<OpenMM_LangevinMiddleIntegrator*>(new OpenMM::LangevinMiddleIntegrator(temperature, frictionCoeff, stepSize));
}
OPENMM_EXPORT void OpenMM_LangevinMiddleIntegrator_destroy(OpenMM_LangevinMiddleIntegrator* target) {
    delete reinterpret_cast<OpenMM::LangevinMiddleIntegrator*>(target);
}
OPENMM_EXPORT double OpenMM_LangevinMiddleIntegrator_getTemperature(const OpenMM_LangevinMiddleIntegrator* target) {
    double result = reinterpret_cast<const OpenMM::LangevinMiddleIntegrator*>(target)->getTemperature();
    return result;
}
OPENMM_EXPORT void OpenMM_LangevinMiddleIntegrator_setTemperature(OpenMM_LangevinMiddleIntegrator* target, double temp) {
    reinterpret_cast<OpenMM::LangevinMiddleIntegrator*>(target)->setTemperature(temp);
}
OPENMM_EXPORT double OpenMM_LangevinMiddleIntegrator_getFriction(const OpenMM_LangevinMiddleIntegrator* target) {
    double result = reinterpret_cast<const OpenMM::LangevinMiddleIntegrator*>(target)->getFriction();
    return result;
}
OPENMM_EXPORT void OpenMM_LangevinMiddleIntegrator_setFriction(OpenMM_LangevinMiddleIntegrator* target, double coeff) {
    reinterpret_cast<OpenMM::LangevinMiddleIntegrator*>(target)->setFriction(coeff);
}
OPENMM_EXPORT int OpenMM_LangevinMiddleIntegrator_getRandomNumberSeed(const OpenMM_LangevinMiddleIntegrator* target) {
    int result = reinterpret_cast<const OpenMM::LangevinMiddleIntegrator*>(target)->getRandomNumberSeed();
    return result;
}
OPENMM_EXPORT void OpenMM_LangevinMiddleIntegrator_setRandomNumberSeed(OpenMM_LangevinMiddleIntegrator* target, int seed) {
    reinterpret_cast<OpenMM::LangevinMiddleIntegrator*>(target)->setRandomNumberSeed(seed);
}
OPENMM_EXPORT void OpenMM_LangevinMiddleIntegrator_step(OpenMM_LangevinMiddleIntegrator* target, int steps) {
    reinterpret_cast<OpenMM::LangevinMiddleIntegrator*>(target)->step(steps);
}
...
OPENMM_EXPORT OpenMM_Continuous1DFunction* OpenMM_Continuous1DFunction_create(const OpenMM_DoubleArray* values, double min, double max, OpenMM_Boolean periodic) {
    return reinterpret_cast<OpenMM_Continuous1DFunction*>(new OpenMM::Continuous1DFunction(*reinterpret_cast<const std::vector< double >*>(values), min, max, periodic));
}
