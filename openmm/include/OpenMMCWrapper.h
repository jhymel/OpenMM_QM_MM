...
extern OPENMM_EXPORT void OpenMM_Platform_setPropertyValue(OpenMM_Platform* target, OpenMM_Context* context, const char* property, const char* value);
...
/* State */
typedef enum {
  OpenMM_State_Positions = 1, OpenMM_State_Velocities = 2, OpenMM_State_Forces = 4, OpenMM_State_Energy = 8, OpenMM_State_Parameters = 16, OpenMM_State_ParameterDerivatives = 32, OpenMM_State_IntegratorParameters = 64, OpenMM_State_Vext_grids = 128
...
extern OPENMM_EXPORT const OpenMM_DoubleArray* OpenMM_State_getVext_grid(const OpenMM_State* target);
